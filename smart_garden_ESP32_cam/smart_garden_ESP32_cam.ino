...
void dataLogging(){
  ...
  if(sensorValue == 1){
    Firebase.pushString(firebaseData,"data_log/soil moisture/rh_tanah","Tanah Kering");
  }
  if(sensorValue == 0){
    Firebase.pushString(firebaseData,"data_log/soil moisture/rh_tanah","Tanah Lembab");
  }
  delay(2000);
}
